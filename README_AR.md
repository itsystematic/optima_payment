...
- راجع **[دليل استخدام الشيكات](docs/cheque/user-guide.md)** لسير العمل الكامل.
...
- إنشاء قيود محاسبية دقيقة لكل عملية متعلقة بخطابات الضمان.
- الوصول إلى **تقرير خطابات الضمان البنكية** لمراقبة الضمانات.
- راجع **[دليل استخدام خطاب الضمان](docs/bank-guarantee/user-guide.md)** للبدء.
...
- **للمستخدمين والمنفّذين:** [الشيكات](docs/cheque/user-guide.md) · [خطاب الضمان](docs/bank-guarantee/user-guide.md) · [الاعتماد المستندي](docs/letter-of-credit/user-guide.md)
- **للمطورين:** [الشيكات](docs/cheque/reference.md) · [خطاب الضمان](docs/bank-guarantee/reference.md) · [الاعتماد المستندي](docs/letter-of-credit/reference.md) · [الاختبارات](docs/development/testing.md) · [بنية الإعداد](docs/setup/architecture.md)
