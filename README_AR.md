...
- راجع **[دليل استخدام الاعتماد المستندي](docs/user-guide-letter-of-credit.md)** للبدء.
...
- **للمستخدمين والمنفّذين:** [دليل استخدام الاعتماد المستندي](docs/user-guide-letter-of-credit.md)
- **للمطورين:** [مرجع الاعتماد المستندي](docs/letter-of-credit.md) · [الاختبارات](docs/testing.md) · [بنية الإعداد](docs/setup-architecture.md)
